...
def lnClick():
    print(calcLn(float(e1.get()), float(e2.get()), int(e3.get())))
...
lnButton = Button(root, command = lnClick, text="ln(x)", fg="black").grid(row=3, column=5, sticky=W, pady=4)
arcTanButton = Button(root, command = arcTanClick, text="arctan(x)", fg="black").grid(row=3, column=6, sticky=W, pady=4)
arcSinButton = Button(root, command = arcSinClick, text="arcsin(x)", fg="black").grid(row=3, column=7, sticky=W, pady=4)
arcCosButton = Button(root, command = arcCosClick, text="arccos(x)", fg="black").grid(row=3, column=8, sticky=W, pady=4)
